...
class DiceLoss(nn.Module):
    ...
    def forward(self, pred_stage1, pred_stage2, target, num_organ, size):
        """
        ...
        # 首先将金标准拆开
        organ_target = torch.zeros((target.size(0), num_organ + 1, size, 256, 256)).cuda()
...
#        print('dice_stage1 = ', dice_stage1.data)
#        print('dice_stage2 = ', dice_stage2.data)
