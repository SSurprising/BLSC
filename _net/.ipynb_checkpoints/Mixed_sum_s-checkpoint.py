...
# the size of the third kernel in E4(D1), E5
channel1 = 5
channel2 = 3
...
class ResUNet_1(nn.Module):
    ...
    def __init__(self, training, inchannel, stage):
        ...
        self.encoder_stage4_2 = nn.Sequential(
            ...
            nn.Conv3d(128, 128, (channel1, 1, 1), 1, padding=(int(0.5 * (channel1-1)), 0, 0)),
            nn.PReLU(128),
        )
        ...
        self.encoder_stage5_2 = nn.Sequential(
            ...
            nn.Conv3d(256, 256, (channel2, 1, 1), 1, padding=(int(0.5*(channel2-1)), 0, 0)),
            nn.PReLU(256),
        )
    ...
    def forward(self, inputs):
        ...
        long_range2   = long_range2_1 + long_range2_2 + short_range1
        ...
        long_range3   = long_range3_1 + long_range3_2 + short_range2
        ...
        long_range4   = long_range4_1 + long_range4_2 +  short_range3
        ...
        outputs_0   = outputs_0_1 + outputs_0_2 + short_range4
        ...
        outputs_1   = outputs_1_1 + outputs_1_2 + short_range5
        ...
        outputs_2   = outputs_2_1 + outputs_2_2 + short_range6
        ...
        outputs_3   = outputs_3_1 + outputs_3_2 + short_range7
